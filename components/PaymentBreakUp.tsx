...
const PaymentBreakUp = () => {
  ...
  const workSpanValue = toRoundNumber(outcome.principalAmount) < 1 ? 1 : toRoundNumber(outcome.principalAmount);
  const payload = [
    { name: "life-span", value: 60 },
    { name: "work-span", value: workSpanValue },
  ];
